...
save(train_1, test_2, test, train, data_folds, file = "attempt_2/results/initial_setup.rda")
...
save(init_recipe, file = "attempt_2/results/init_recipe.rda")
...
save(recipe_1, file = "attempt_2/results/recipe_1.rda")
############################
...
save(recipe_2, file = "attempt_2/results/recipe_2.rda")
...
save(recipe_3, file = "attempt_2/results/recipe_3.rda")
##################################
# ryans vars 
...
save(recipe_4, file = "attempt_2/results/recipe_4.rda")
